...
const InfoColaboretion = () => {
  return (
    <section className="my-11 text-xl" id="info-colaboration">
      ...
      <p className="mt-4 mb-8">
        ...
        nuevos horizontes. Descubre cómo puedes ser parte de esta transformación
      </p>
        ...
        <div className="flex">
          ...
          <div className="flex-1">
            ...
            <p className="mt-5 mb-6">
              ...
              fuerza que impulse a más personas hacia una educación de calidad,
