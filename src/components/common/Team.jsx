...
const Team = () => {
  return (
    <section className="py-24 text-xl bg-section2" id='team'>
      <h2 className="text-blue_title text-[2.5rem] font-bold">Nuestro equipo</h2>
      <p className="mt-8 mb-16">En La Cantera, creemos que el corazón de este proyecto reside en las personas que la hacen posible. Nuestro equipo está compuesto por apasionados profesionales dedicados a la misión de transformar vidas a través de la educación en tecnología. ¡Conócelos!</p>
